...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove New Role Creation', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.Create-Role');
        });
        ...
        it('production admin can go to manage permissions page to see permissions', function () {
            ...
            prodManageUser.manageProductionRoles();
            utilities.checkIfAvailableById('createNewRole');
        });
