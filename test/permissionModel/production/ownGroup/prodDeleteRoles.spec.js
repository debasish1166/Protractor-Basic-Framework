...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove Deleting Roles', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.Delete-Roles');
        });
        ...
        it('production admin can go to manage permissions page to see permissions', function () {
            ...
            manageProdUser.manageProductionRoles();
            expect(roles.deleteButton.isPresent()).toBe(false);
