...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove Listing Users', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.List-Users');
        });
        ...
        it('production admin can not go to manage permissions page', function () {
            prodHome.signedUser.click().then(function () {
                browser.driver.sleep(2000);
                utilities.checkIfAvailableById('managePermissions');
            });
        });
