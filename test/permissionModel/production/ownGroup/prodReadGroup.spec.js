...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove Group Read', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.Read-Group');
        });
        ...
        it('production admin cant see the Production Tab', function () {
            utilities.checkIfAvailableById('ProductionTab');
        });
