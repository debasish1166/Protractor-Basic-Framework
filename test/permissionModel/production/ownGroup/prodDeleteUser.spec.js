...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove Delete User Permission', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.Delete-User');
        });
        ...
        // Bug needs fixing ERP-3992
        it('production admin can go to edit user details page', function () {
            element.all(by.id('editButton')).first().click();
            browser.driver.sleep(3000);
            utilities.checkUrl(utilities.editProdUser);
            utilities.checkIfAvailableById('softDeleteButton');
        });
