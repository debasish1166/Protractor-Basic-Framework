...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove New User Creation', function () {
        ...
        it('office admin can go to the edit permissions page of production groups', function () {
            ...
            expect(manageUser.getCurrentUrl()).toEqual(utilities.urlEditPermission);

        });

        it('office admin can edit permissions and save changes', function () {
            browser.driver.sleep(7000);
            editGroup.changePermissionWithCss('.Create-User');
        });
        ...
        it('production admin can go to manage permissions page to see permissions', function () {
            prodManageUser.goToProduction();
            utilities.checkIfAvailableById('newProductionUserButton');
        });
