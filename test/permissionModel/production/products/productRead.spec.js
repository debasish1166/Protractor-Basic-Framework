...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove Read Products', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.Read');
        });
        ...
        it('production admin can not see the product read button', function () {
            utilities.checkIfAvailableById('productReadButton');
        });
