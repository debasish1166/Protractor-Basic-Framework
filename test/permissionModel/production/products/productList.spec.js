...
(function () {
    ...
    describe('Testing the permission model of a Production user - Remove List Products', function () {
        ...
        it('office admin can edit permissions and save changes', function () {
            ...
            editGroup.changePermissionWithCss('.List');
        });
        ...
        it('production admin can not go to manage products page', function () {
            prodHome.signedUser.click().then(function () {
                browser.driver.sleep(2000);
                utilities.checkIfAvailableById('manageProducts');
            });
        });
